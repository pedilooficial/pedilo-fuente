...
### Objetivo
Eventos críticos, generador, datos, inmutabilidad, métricas fuente.

### Alcance — incluye
Contenido operativo y reglas de Eventos y Auditoría según fuentes.
...
### Estado actual (repo)
/orders/{id}/events inmutable; eventos por acción en Functions; alimenta L1.

### Estado objetivo (Plano Maestro)
Events V1 existe. Objetivo: catálogo completo plano + métricas.

### Brecha de implementación
Registrar todo evento sensible; prohibir delete cliente.
