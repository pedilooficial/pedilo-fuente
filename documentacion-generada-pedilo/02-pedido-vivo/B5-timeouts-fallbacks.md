...
### Objetivo
Timeouts por estado, advertencias, responsable, qué ve cliente.

### Alcance — incluye
Contenido operativo y reglas de Timeouts y Fallbacks según fuentes.
...
### Estado actual (repo)
INITIAL_TIMEOUT_POLICY declarativo en birth; sin motor autónomo.

### Estado objetivo (Plano Maestro)
Objetivo: ejecución sistema + escalada Admin + mensaje público seguro.

### Brecha de implementación
Cloud Function scheduler o worker; sin perder pedidos vivos.
