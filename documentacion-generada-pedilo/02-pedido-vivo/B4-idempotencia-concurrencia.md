# B4 — Idempotencia y Concurrencia
...
### Objetivo
Doble acción, versión, claves idempotentes, transacciones.

### Alcance — incluye
Contenido operativo y reglas de Idempotencia y Concurrencia según fuentes.
...
### Estado actual (repo)
publicIdempotencyKey en birth; expectedVersion en acciones; tests live_order_birth_contract.

### Estado objetivo (Plano Maestro)
V1 cumple birth + versión. Objetivo: todas acciones críticas idempotentes.

### Brecha de implementación
actionId en acciones restantes; tests concurrencia.
