# D5 — Solicitud Repartidor por Local
...
### Objetivo
4º tipo; local solicita driver.

### Alcance — incluye
Contenido operativo y reglas de Solicitud Repartidor por Local según fuentes.
...
Bloque solicitud repartidor.

### Brecha de implementación
createStoreDriverRequest + flujo E1.
