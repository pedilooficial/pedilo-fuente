...
### Objetivo
Visible sin operar pedidos.

### Alcance — incluye
Contenido operativo y reglas de Local Catálogo Pasivo según fuentes.
...
### Estado actual (repo)
stores visible sin user operativo.

### Estado objetivo (Plano Maestro)
Plano local pasivo.

### Brecha de implementación
Alta usuario activo vía F3.
