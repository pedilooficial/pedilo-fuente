...
### Objetivo
Aceptar, rechazar, preparar, listo, incidencia.

### Alcance — incluye
Contenido operativo y reglas de Local Operativo según fuentes.
...
### Estado actual (repo)
StoreApp V1 + operateLiveOrder.

### Estado objetivo (Plano Maestro)
Plano local operativo + bloque tienda.

### Brecha de implementación
Chat, solicitud repartidor, demoras.
