...
### Objetivo
Multi-store, carrito mono-local, snapshot.

### Alcance — incluye
Contenido operativo y reglas de Tienda Multi-Store según fuentes.
...
### Estado actual (repo)
Firestore multi-store; seed 1 local.

### Estado objetivo (Plano Maestro)
Bloque multi-store.

### Brecha de implementación
Más locales productivos sin hardcode.
