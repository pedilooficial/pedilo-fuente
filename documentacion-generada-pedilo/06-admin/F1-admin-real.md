...
### Objetivo
Operación, config, roles, intervención.

### Alcance — incluye
Contenido operativo y reglas de Admin Real según fuentes.
...
### Estado actual (repo)
Operación real; config/roles shell.

### Estado objetivo (Plano Maestro)
Plano admin + bloques.

### Brecha de implementación
F2 F3 backend persistencia.
