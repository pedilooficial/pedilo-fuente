...
### Objetivo
Acciones privilegiadas, auditoría.

### Alcance — incluye
Contenido operativo y reglas de Intervención Admin según fuentes.
...
### Estado actual (repo)
adminOrderAction + operateLiveOrder admin.

### Estado objetivo (Plano Maestro)
Plano intervención.

### Brecha de implementación
Matriz completa intervenciones financieras.
