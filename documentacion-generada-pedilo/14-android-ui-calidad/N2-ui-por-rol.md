...
### Objetivo
Pantallas, acciones, permisos.

### Alcance — incluye
Contenido operativo y reglas de UI por Rol según fuentes.
...
### Estado actual (repo)
publicuser, admin, store, driver.

### Estado objetivo (Plano Maestro)
Plano + diseño aprobado.

### Brecha de implementación
Completar flujos G,J.
