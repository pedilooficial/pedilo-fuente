# A4 — Matriz de Conservación y Reemplazo
...
### Objetivo
Clasificar cada parte del repo con motivo documentado.

### Alcance — incluye
Contenido operativo y reglas de Matriz de Conservación y Reemplazo según fuentes.
...
| **Implementación repo** | Matriz de decisión cerrada |

### Estado actual (repo)
Matriz aplicada en Q3.

### Estado objetivo (Plano Maestro)
Repo clasificado según Q2.

### Brecha de implementación
Ninguna pieza crítica sin clasificación.

### Contradicciones resueltas
C-01 resuelta en A5. C-02 resuelta: prevalece repo HEAD `50c51fa`.

### Criterio de implementación futura
Implementar según Q4 orden.
