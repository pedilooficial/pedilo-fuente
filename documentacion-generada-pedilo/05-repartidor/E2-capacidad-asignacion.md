...
### Objetivo
Capacidad, doble toma, transacción.

### Alcance — incluye
Contenido operativo y reglas de Capacidad y Asignación según fuentes.
...
### Estado actual (repo)
Sin capacidad configurable.

### Estado objetivo (Plano Maestro)
Plano + bloque alta roles.

### Brecha de implementación
capacidad_base en config Admin.
