...
### Objetivo
Base 3500, lluvia 4000, zona +1500; snapshot.

### Alcance — incluye
Contenido operativo y reglas de Tarifas según fuentes.
...
### Estado actual (repo)
No persistido en repo.

### Estado objetivo (Plano Maestro)
Plano §tarifas + bloque modos.

### Brecha de implementación
Config F2 + snapshot en birth.
