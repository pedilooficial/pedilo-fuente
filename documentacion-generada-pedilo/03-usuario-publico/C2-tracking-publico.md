...
### Objetivo
Estados públicos seguros; ocultar internos.

### Alcance — incluye
Contenido operativo y reglas de Tracking Público según fuentes.
...
### Estado actual (repo)
getPublicOrderTracking + publicStatus.

### Estado objetivo (Plano Maestro)
Plano tracking §6.5.

### Brecha de implementación
Mapeo completo estados internos→públicos.
