...
### Objetivo
Home, Tienda, local, carrito, +, tracking, convenciones.

### Alcance — incluye
Contenido operativo y reglas de Usuario Público según fuentes.
...
### Estado actual (repo)
Público Firebase V1 real; reclamo placeholder.

### Estado objetivo (Plano Maestro)
Plano §usuario público completo.

### Brecha de implementación
Cancelación por estado; reclamo backend; validación WhatsApp.
